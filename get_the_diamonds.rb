...
while true do
  ...
  if location == "hall" && user_input == "look"
    puts "You are standing in a hall with a marble floor. You see a door."
  elsif location == "hall" && user_input == "north"
    location = "study"
  elsif location == "study" && user_input == "look"
    puts "You are in a warm and cosy study. You see a safe. You see a desk."
  elsif location == "study" && user_input == "look at desk"
    puts "You see a piece of paper that reads, The combination is 2451."
  elsif location == "study" && user_input == "enter combination 2451"
    puts "You see some diamonds in the safe, pick them up and make your escape"
    break
  elsif location == "study" && user_input == "south"
    location = "hall"
  elsif location == "study" || location == "hall" && user_input == "quit"
    puts "Bye!"
    break    
  end
end  
